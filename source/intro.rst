...
here: https://github.com/pytlab/scaks
...
To this end, we present a Python module called “scaks” with web GUI to help 
...
programs, scaks provide robust and flexible interfaces to help expert users 
...
application using scaks as the back-end calculation core. Then we can run the 
