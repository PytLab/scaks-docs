.. currentmodule:: catynetics

Introduction
=============

Welcome to the `catynetics` documentation!
...
here: https://github.com/pytlab/catynetics
...
To this end, we present a Python module called “catynetics” with web GUI to help 
...
programs, catynetics provide robust and flexible interfaces to help expert users 
...
application using catynetics as the back-end calculation core. Then we can run the 
